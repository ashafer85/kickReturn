...
class KRGame {
  ...
  handleEnd() {
    ...
    if (this.winner === true) {
      this.ctx.drawImage(this.refTD, 60, 100, 200, 200);
      this.ctx.fillStyle = 'red';
      this.ctx.font = '60px Arial';
      this.ctx.fillText('TOUCHDOWN!!!', 100, 250);
      this.ctx.fillStyle = 'black';
      this.ctx.font = '20px Times';
      this.ctx.fillText('Press SPACE BAR to Play Again', 180, 275);
      ...
      this.ctx.fillStyle = 'black';
      this.ctx.font = '20px Times';
      this.ctx.fillText('Press SPACE BAR to Try Again', 100, 115);
    } else {
      this.ctx.drawImage(this.refDB, (60 + this.kR.onLeft), 100, 200, 250);
      this.ctx.fillStyle = 'red';
      this.ctx.font = '40px Arial';
